...
public abstract class Soldier extends ImageObject{
	...
	public Soldier(int my_health, int my_armor, int my_attackP, boolean evilOrNot){
		...
		//figure out what i am (for the toString)
...
/** #################################........COMBAT FUNCTIONS .....................................########################################### **/
	...
	public void displayDmg(int d){
		if(isDead())
			return;
		display.setText(d); 
	}  //shows pretty floating numbers (negative numbers in red, positive in green)
	
	public void displayText(String s){
		if(isDead())
			return;
		display.setText(s); 
	} //shows pretty floating text
